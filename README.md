# HappyPaws: A Pet Adoption System | MERN Stack Portfolio with Admin Panel
"HappyPaws" is a website where you can either give a pet up for adoption or adopt one. If you have a pet you can't care for anymore, you fill out a form. The admin then decides if they can put your pet on HappyPaws. If they approve, they'll ask you to bring the pet to an adoption center.

If you want to adopt a pet, you fill out a form with your details. The admin gets a lot of requests and picks the best one. If they choose you, they'll delete the other requests and take the pet off HappyPaws. They'll keep a record of the pet and your contact info.

So, HappyPaws makes it easy to find new homes for pets and connect them with people who want to adopt.

### Watch HappyPaws in Action

[![Watch the video](https://github.com/KaShiekzmi/HappyPaws-A-Pet-Adoption-System-MERN-Stack-Portfolio-with-Admin-Panel/assets/114513868/521826b2-10d9-41b4-aec3-3497e23d2cbb)](https://www.youtube.com/watch?v=wXQpAoX7_QY)

Click the image above to watch a demo of HappyPaws on YouTube.
...
- Approved pets are listed on HappyPaws for potential adopters to view.
...
- HappyPaws offer detailed pet profiles with photos and descriptions.

## Technology Stack
HappyPaws is built using the MERN stack (MongoDB, Express.js, React, Node.js).
...
1. Clone the repository: `git clone https://github.com/KaShiekzmi/HappyPaws-A-Pet-Adoption-System-MERN-Stack-Portfolio-with-Admin-Panel.git`
